    ...
    <header className="app-header">
      ...
      <div className="header-actions">
        ...
        {hasFile && !isConverting && (
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            <input
              ...
              style={{ width: "60px", padding: "6px", borderRadius: "var(--radius-sm)", border: "1px solid var(--color-border-primary)", background: "var(--color-bg-secondary)", color: "var(--color-text-primary)", fontSize: "14px" }}
            ...
            />
            <button className="btn btn-primary" onClick={() => onStartConversion(parseInt(startPage) || 1, parseInt(endPage) || totalPages)}>
        ...
        {hasFile && convertedCount > 0 && !isConverting && (
          <button className="btn btn-success" onClick={onDownloadAll}>
            <svg
              width="16"
              height="16"
              viewBox="0 0 24 24"
